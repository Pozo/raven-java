...
public class BreadcrumbTest {
    ...
    @Test
    public void testBreadcrumbsThroughRecording() {
    ...
    @Test
    public void testBreadcrumbsThroughUnbuildedEventBuilder() {
        raven.addBuilderHelper(new ContextBuilderHelper(raven));
    ...
    @Test
    public void testBreadcrumbsThroughBuildedEventBuilder() {
        raven.addBuilderHelper(new ContextBuilderHelper(raven));
